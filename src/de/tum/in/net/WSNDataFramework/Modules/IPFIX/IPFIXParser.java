...
public class IPFIXParser {
	...
	public Map<String,List<IPFIXField>> parse(byte[] packet) throws ParseException {
		...
		try {
			...
			if (version != _getSupportedVersion()) {
				throw new ParseException("IPFIXParser: packet has unsupported version, expected "+_getSupportedVersion()+", got: "+version+".");
			}
	...
	//	 */
	//	protected IPFIXParser log(String msg) {
	//		_log.append(msg+"\n");
	//		return this;
	//	}
	//	public IPFIXParser clearLog() {
	//		_log=new StringBuffer();
	//		return this;
	//	}
	/**
